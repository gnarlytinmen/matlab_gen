function [dots,delta_dots,h]=rand_flowfield(az,el,trans_vel,purs_angle,rot_vel,fixpoint,num_dots)

% Usage: rand_flowfield(az,el,vt,purs_angle,pur_vel,fixpoint)
...
figure;clf;hold on;
quiver3(X,Y,Z,dx_dt,dy_dt,dz_dt,15,'Color',[0.3 0.3 0.3],'LineWidth',1.5,'AlignVertexCenters','on');%,'ShowArrowHead','off');
if fixpoint==1
